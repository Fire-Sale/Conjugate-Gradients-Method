...
//         y[i][j][k] = x[i][j][k];
    cblas_scopy(XDIM * YDIM * ZDIM, &x[0][0][0], 1, &y[0][0][0], 1);
}
...
//         z[i][j][k] = x[i][j][k] * scale + y[i][j][k];
    ...
    cblas_scopy(XDIM * YDIM * ZDIM, &x[0][0][0], 1, &z[0][0][0], 1);
    cblas_sscal(XDIM * YDIM * ZDIM, scale, &z[0][0][0], 1);
    cblas_saxpy(XDIM * YDIM * ZDIM, 1, &y[0][0][0], 1, &z[0][0][0], 1);
}
